...
struct FLRegisterForm: View {
    var body: some View {
        VStack(spacing: 0) {
            ...
            FLTextField(placeholder: RegisterConstants.Register.firstName)
                .accessibilityIdentifier("FirstNameTF")
            FLTextField(placeholder: RegisterConstants.Register.lastName)
                .accessibilityIdentifier("LastNameTF")
